...
file_path = 'pwd';
addpath('figure code');
addpath(fullfile('stat_code','mixed_between_within_anova'));
addpath(fullfile('stat_code','computeCohen_d'));

% setting behavioral data path
load('info_sub63.mat'); % final subjectlist of the project

% loading the math verification data during fMRI scan
load('Scantask_All_Data.mat') % PID session training_set Choice_ACC

% analysis_list.mat % 67 original subjectlist with potential missing data
% PID_train_group.mat % training index for each participants
% sublist_nores.mat % subject with no response
% sublist_lowacc.mat % subject with random accuracy
...
% plot
output_path = fullfile(file_path,'results','Behavior','figures','ASD_TD_scanACCgain_trained.tiff');
...
% plot
output_path = fullfile(file_path,'results','Behavior','figures','supplementary','ASD_TD_scanACCgain_untrained.tiff');
...
%% plot
output_path = fullfile(file_path,'results','Behavior','figures','ASD_scanACC_trained.tiff');
...
output_path = fullfile(file_path,'results','Behavior','figures','TD_scanACC_trained.tiff');
...
output_path = fullfile(file_path,'results','Behavior','figures','supplementary','ASD_scanACC_untrained.tiff');
...
output_path = fullfile(file_path,'results','Behavior','figures','supplementary','TD_scanACC_untrained.tiff');
...
save(fullfile(file_path,'Behavior','scan task performance','taskscan_change_ACC.mat'),'scantask_change_ACC','scantask_change_title');