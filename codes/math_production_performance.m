...
% plot
output_path = fullfile(file_path,'results','Behavior','figures','ASD_TD_strategyRTgain_trained.tiff');
...
% plot
output_path = fullfile(file_path,'results','Behavior','figures','supplementary','ASD_TD_strategyRTgain_untrained.tiff');
bar_group_small(ASD_accgain,TD_accgain,[-1.1 1],[-0.5 0 0.5],[-50 0 50], {'ASD','TD'}, 'RT gain (%)', output_path)
...
save(fullfile(file_path,'analysis','Behavior','strategy assessment','RT_strategy_performance.mat'),'RT_strategy_performance','RT_strategy_performance_title')

%% pics for RT
output_path = fullfile(file_path,'results','Behavior','figures','ASD_strategyRT_trained.tiff');
bar_time(ASD_pre_train,ASD_post_train,[157, 211, 250],[25, 25, 112],[0 13],[0, 5, 10], {'0','5','10'},{'Pre','Post'}, 'ASD','RT (s)', output_path,'descend')
output_path = fullfile(file_path,'results','Behavior','figures','TD_strategyRT_trained.tiff');
bar_time(TD_pre_train,TD_post_train,[255 166 158],[128 0 0],[0 13], [0, 5, 10], {'0','5','10'},{'Pre','Post'}, 'TD','RT (s)', output_path,'descend')

output_path = fullfile(file_path,'results','Behavior','figures','supplementary','ASD_strategyRT_untrained.tiff');
...
output_path = fullfile(file_path,'results','Behavior','figures','supplementary','TD_strategyRT_untrained.tiff');
