...
% loading the strategy data
load('strategy_Data.mat')
% PID_train_group.mat % training index
% 'scanbeh_sublist.mat % list from scan behaviral data
% PID % PID
% pre_post % pre/post index
% traingroup % problems set index
% triallable % formal trials
% accuracy_first % accuracy
% equationRT  % RT
% spoilRT % error RT index
...
save(fullfile(box_path,'analysis','Behavior','strategy assessment','sub_preference.mat'),'sub_preference','sub_preference_title');
...
% pics
output_path=fullfile(box_path,'results','Behavior','figures','ASD_TD_strategy_preferecne_train_pre.tiff');
...
% pics
output_path=fullfile(box_path,'results','Behavior','figures','ASD_TD_strategy_preferecne_train_post.tiff');
...
% pics
output_path=fullfile(box_path,'results','Behavior','figures','supplementary','ASD_TD_strategy_preferecne_untrain_pre.tiff');
...
% pics
output_path=fullfile(box_path,'results','Behavior','figures','supplementary','ASD_TD_strategy_preferecne_untrain_post.tiff');
...
% pics
output_path=fullfile(box_path,'results','Behavior','figures','ASD_strategy_preferecne_train_untrain_pre.tiff');
...
% pics
output_path=fullfile(box_path,'results','Behavior','figures','ASD_strategy_preferecne_train_untrain_post.tiff');
...
% pics
output_path=fullfile(box_path,'results','Behavior','figures','TD_strategy_preferecne_train_untrain_pre.tiff');
bar_mean_group_strategy(tbl,[0 35],[0:10:30],[0:10:30], {'Trained';'Untrained'}, 'Participants (N)','Pre', output_path);
...
fprintf('-------------------------------------------------------------------\n\n');
% pics
output_path=fullfile(box_path,'results','Behavior','figures','TD_strategy_preferecne_train_untrain_post.tiff');
bar_mean_group_strategy(tbl,[0 30],[0:10:30],[0:10:30], {'Trained';'Untrained'}, 'Participants (N)','Post', output_path)
